...
const de = {
  ...
  // Preisrechner-Labels Runde 2: Pro-Sendung-Sicht, neue Felder.
  calculator: {
    ...
    cFrom: 'ab',
    cPerShipment: 'pro Sendung',
    cResultLabel: 'Pro-Sendung-Kalkulation',
    cBreakdownLabel: 'Pro Sendung',
    cBreakPick: 'Pick & Pack',
    cBreakPack: 'Verpackung',
    cBreakShip: 'Versand',
    cBreakStorage: 'Lagerung anteilig',
    cBreakReturns: 'Retouren',
    cBreakValue: 'Mehrwert',
    cMonthlyLabel: 'Monatliche Spanne',
    cInbound: 'Inbound',
