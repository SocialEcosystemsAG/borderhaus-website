...
const de = {
  ...
  pages: {
    ...
    integrations: {
      title: 'Integrationen',
      lead: 'Wir docken an dein System an, nicht umgekehrt. Anbindung in Stunden, nicht Wochen.',
      api: 'Für alles ohne fertigen Konnektor: unsere REST-API gibt dir Bestände, Bestellungen und Tracking in Echtzeit.',
    },
    locations: {
      title: 'Standorte',
  ...
  // Preisrechner-Labels exakt nach Design-Vorlage.
  calculator: {
    cOrders: 'Bestellungen pro Monat',
    cPicks: 'Artikel pro Bestellung',
    cStorage: 'Stellplätze (Paletten / Fächer)',
    cMarkets: 'Zielmärkte',
